...
sign_var_list<-readRDS("/home/fcasale/Desktop/Paper_2/3_RILs/5_correlation/Results/I.1.2_sw_reg_per_win_significant_variables_2.RDS")
...
graphic_table[,3]<-gsub("METHY_cpg","Methylation level: CpG", graphic_table[,3])
graphic_table[,3]<-gsub("METHY_chg","Methylation level: CHG", graphic_table[,3])
graphic_table[,3]<-gsub("METHY_chh","Methylation level: CHH", graphic_table[,3])
...
pdf("/home/fcasale/Desktop/Paper_2/3_RILs/5_correlation/Results/I.2.1_corr_graphic_all_2.pdf", width = 15, height = 10)
...
file.copy("/home/fcasale/Desktop/Paper_2/3_RILs/5_correlation/Results/I.2.1_corr_graphic_all_2.pdf", 
          "/home/fcasale/Desktop/Paper_2/3_RILs/6_graphics_for_paper/Results/")

file.rename("/home/fcasale/Desktop/Paper_2/3_RILs/6_graphics_for_paper/Results/I.2.1_corr_graphic_all_2.pdf",
            "/home/fcasale/Desktop/Paper_2/3_RILs/6_graphics_for_paper/Results/Figure_2_2.pdf")
...
s<-1000000
#NO LO ENONTRE: rec_list<-readRDS(paste("/home/fcasale/Desktop/Paper_2/3_RILs/5_correlation/Results/B.0_AVERAGE_rec_rates_windows_regions_",s,"_5.RDS", sep = ""))
rec_list<-readRDS(paste("/home/fcasale/Desktop/Paper_2/3_RILs/5_correlation/Results/B.0_AVERAGE_rec_rates_windows_regions_",s,".RDS", sep = ""))
...
count_P<-0; count_D<-0
for (c in 1:7){ 
  graphic_table_chr<-graphic_table[which(graphic_table[,1]==paste0(c,"H")),]
  #peri
  peri<-rec_list[[c]][which(rec_list[[c]][,4]=="P"),2]; count_P<-sum(count_P, length(peri)) 
  peri<-which(as.character(graphic_table_chr[,2])%in%peri)
  #peri neg
  peri_neg<-graphic_table_chr[peri[which(as.numeric(graphic_table_chr[peri,4])<0)],]
  if (is.matrix(peri_neg)==FALSE){peri_neg <- t(as.matrix(peri_neg))}
  tab<-table(peri_neg[,3])  
  for (i in names(tab)){tabla[i,4]<-sum(as.numeric(tabla[i,4]), tab[i])}
  #peri pos
  peri_pos<-graphic_table_chr[peri[which(as.numeric(graphic_table_chr[peri,4])>0)],]
  ...
  distal<-which(as.character(graphic_table_chr[,2])%in%distal)
  #distal neg
  distal_neg<-graphic_table_chr[distal[which(as.numeric(graphic_table_chr[distal,4])<0)],]
  tab<-table(distal_neg[,3])  
  for (i in names(tab)){tabla[i,2]<-sum(as.numeric(tabla[i,2]), tab[i])}
  #distal pos
  distal_pos<-graphic_table_chr[distal[which(as.numeric(graphic_table_chr[distal,4])>0)],]
...
write.csv(tabla, "/home/fcasale/Desktop/Paper_2/3_RILs/5_correlation/Results/I.2.2_win_per_significant_variable_2.csv", row.names = FALSE)
...
#Prepare table for graphic
sign_var_list<-readRDS("/home/fcasale/Desktop/Paper_2/3_RILs/5_correlation/Results/I.1.5_REDUCED_sw_reg_per_win_significant_variables_2.RDS")
graphic_table<-sign_var_list[[1]][["graphic_table"]]  
...
pdf("/home/fcasale/Desktop/Paper_2/3_RILs/5_correlation/Results/I.2.3_REDUCED_corr_graphic_all_2.pdf", width = 15, height = 10)
...
file.copy("/home/fcasale/Desktop/Paper_2/3_RILs/5_correlation/Results/I.2.3_REDUCED_corr_graphic_all_2.pdf", 
          "/home/fcasale/Desktop/Paper_2/3_RILs/6_graphics_for_paper/Results/")

file.rename("/home/fcasale/Desktop/Paper_2/3_RILs/6_graphics_for_paper/Results/I.2.3_REDUCED_corr_graphic_all_2.pdf",
            "/home/fcasale/Desktop/Paper_2/3_RILs/6_graphics_for_paper/Results/Figure_2_REDUCED_2.pdf")
...
write.csv(tabla, "/home/fcasale/Desktop/Paper_2/3_RILs/5_correlation/Results/I.2.4_REDUCED_win_per_significant_variable_2.csv", row.names = FALSE)
