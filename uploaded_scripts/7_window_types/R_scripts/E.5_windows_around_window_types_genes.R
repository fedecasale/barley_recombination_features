...
SVs_proportion<-readRDS("/home/fcasale/Desktop/Paper_2/3_RILs/5_correlation/Results/F.0_gene_proportion_per_window=10000_all_pops.RDS")
...
for (p in Populations){cat(p);cat(":")
  ...
  for (c in 1:7){ cat(c);cat("-")
     ...
     chr_windows<-as.numeric(row.names(SVs_proportion[[c]]))
...
saveRDS(windows_around_break_list, "/home/fcasale/Desktop/Paper_2/3_RILs/7_window_types/Results/E_windows_around/E.5.0_windows_around_break_list.RDS")

saveRDS(graphic_list, "/home/fcasale/Desktop/Paper_2/3_RILs/7_window_types/Results/E.5.1_graphic_list.RDS")
...
pdf("/home/fcasale/Desktop/Paper_2/3_RILs/7_window_types/Results/E_windows_around/E.5.2_windows_around_genes.pdf", width = 8, height = 10)

ggplot()+
  geom_line(data = graphic_table, aes(x = window, y = SVs_proportion, color = window_type)) +
  geom_vline(xintercept = 0, linetype = "dashed")+
  
  scale_y_continuous(name = "Gene occupancy", 
                     limits = c(0, 0.2),
