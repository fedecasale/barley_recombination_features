...
file.remove("/scratch/Federico/3_RILs/3_SVs/Results/G_windows_closest_SV/G.2.2.2_windows_types_TUKEY.xlsx")
...
cat(fill = TRUE)
write.xlsx(tabla_0, "/scratch/Federico/3_RILs/3_SVs/Results/G_windows_closest_SV/G.2.2.2_windows_types_TUKEY.xlsx", sheetName = v, append = TRUE)
...
file.remove("/scratch/Federico/3_RILs/3_SVs/Results/G_windows_closest_SV/G.2.2.3_windows_types_WILCOX.xlsx")
...
for (v in SVs){ cat(v); cat(": ", fill = TRUE)
  ...
  s<-"big" 
    ...
    for (p in Populations){ cat(p); cat("-")   
      ...
      write.xlsx(p.values_table, "/scratch/Federico/3_RILs/3_SVs/Results/G_windows_closest_SV/G.2.2.3_windows_types_WILCOX.xlsx", sheetName = paste(v,"_",p, sep = ""), append = TRUE)
    }#p
